...
def train(args):
    ...
    train_file = '/root/thinh/cochrane/cochrane_train.csv'
    dev_file = '/root/thinh/cochrane/cochrane_dev.csv'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--truncate_from_left", default=False, type=bool)
